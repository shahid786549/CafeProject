...
public class BillServiceImple implements BillService {
    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        ...
        if (validateRequestMap(requestMap)){
            ...
            Paragraph footer = new Paragraph("Total :"+requestMap.get("totalAmount")+"Thank you for visiting.Please visit again!!",getFont("Data"));
            document.add(footer);
            document.close();
    ...
    public ResponseEntity<List<Bill>> getBills() {
        ...
        if(jwtFillter.isAdmin())
        {
            ...
            list = billRepo.getBillByUserName(jwtFillter.getCurrentUser());
        }
    ...
    private void insertBill(Map<String, Object> requestMap) {
        try{
            ...
            bill.setCreatedBy(jwtFillter.getCurrentUser());
            billRepo.save(bill);
